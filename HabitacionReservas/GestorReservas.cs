      ...
      DateTime fechaReserva, int duracion, double tarifa)
        {
            ...
            if (_reserva.Any(r => r.NumeroHabitacion == numeroHabitacion && r.FechaReserva == fechaReserva))
            {
        ...
        public void EditarReserva(int numeroHabitacion, DateTime fechaReserva, string nuevoNombreCliente,
            int nuevaDuracion)
        {
